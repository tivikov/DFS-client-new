...
{    
    ...
    */
    ...
    /**
    * @var null|KeywordPerformanceGetLocationsAndLanguagesEntityMainTasksData $data;
    */
    public $data = null;

    /**
    * @var array|KeywordPerformanceGetLocationsAndLanguagesEntityMainTasksResult[] $result;
    */
    public $result = [];
