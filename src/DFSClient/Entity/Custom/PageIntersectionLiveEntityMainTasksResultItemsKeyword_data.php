...
{    
    ...
    */
    ...
    /**
    * @var null|PageIntersectionLiveEntityMainTasksResultItemsKeyword_dataKeyword_info $keyword_info;
    */
    public $keyword_info = null;

    /**
    * @var null|PageIntersectionLiveEntityMainTasksResultItemsKeyword_dataImpressions_info $impressions_info;
    */
    public $impressions_info = null;

    /**
    * @var null|PageIntersectionLiveEntityMainTasksResultItemsKeyword_dataBing_keyword_info $bing_keyword_info;
    */
